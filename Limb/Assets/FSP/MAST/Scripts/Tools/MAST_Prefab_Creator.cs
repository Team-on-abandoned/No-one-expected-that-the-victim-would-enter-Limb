...
public class MAST_Prefab_Creator : EditorWindow
{
    ...
    [SerializeField] private bool flagSplitMeshByMat = true;
    ...
    private void GUIOrganizeMaterials()
    {
        ...
        GUILayout.Label("All Materials (Old > New) - Double-click to Add/Remove");
        ...
        GUILayout.Label("Selected Materials (Old > New) - Double-click to Remove");
    ...
    private void GUILinkMaterials()
    {
            ...
            "Choose a Material to subtitute for the selected material")))
        {
            ...
            string matPath =
                ...
                Application.dataPath, new[] { "Material files", "mat"});
    ...
    private void GUICreatePrefabs()
    {
        ...
        EditorGUILayout.BeginVertical(EditorStyles.helpBox);
        GUILayout.Space(5f);
        flagSplitMeshByMat = GUILayout.Toggle(flagSplitMeshByMat, "Split Mesh by Material (Not Implemented Yet)");
        GUILayout.Space(5f);
        EditorGUILayout.EndVertical();
        GUI.enabled = true;
        ...
        if (GUILayout.Button(new GUIContent("Create Prefabs", "Create prefabs")))
        {
            PrepModels.CreatePrefabs(modelPath, sourceMat, new List<string>(sourceMatName),
                                     ...
                                     flagAddMeshCollider, flagAddEmptyParent, flagSplitMeshByMat);
        }
